...
@section('content')
    ...
    <section id="">
        <div class="row justify-content-center">
            ...
            @canany(['property_types_create', 'property_types_edit'])
                @if (isset($editRow['id']) || canPermission('property_types_create'))
                ...
                <div class="box box-table table-responsive">
                    <table class="table table-modern table-inverse">
                        <thead class="thead-inverse">
                            <tr>
                                @canany(['property_types_delete', 'property_types_edit'])
                                    <th>التحكم</th>
                                @endcanany
                                <th>النوع</th>
                                <th>تاريخ الإضافة</th>
                                ...
                                <tr class="parents">
                                    @canany(['property_types_delete', 'property_types_edit'])
                                        <td>
                                            ...
                                            @can('property_types_delete')
                                                <form class="ajax-delete d-inline-block"
                                                    action="{{ route('properties.types.destroy') }}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
