...
@section('content')
    ...
    <section id="">
        <div class="row justify-content-center">
            ...
            @canany(['property_features_create', 'property_features_edit'])
                @if (isset($editRow['id']) || canPermission('property_features_create'))
