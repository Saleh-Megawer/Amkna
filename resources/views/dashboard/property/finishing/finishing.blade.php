...
@section('content')
    ...
    <section id="">
        <div class="row justify-content-center">
            ...
            @canany(['property_furnishing_create', 'property_furnishing_edit'])
                @if (isset($editRow['id']) || canPermission('property_furnishing_create'))
            ...
            <div
                class="@canany(['property_furnishing_create', 'property_furnishing_edit']) col-lg-8 col-md-7 @else col-12 @endcanany">

                <div class="box box-table px-0 pt-2 table-responsive">
                    <table class="table table-modern table-modern-sm table-inverse">
                        <thead class="thead-inverse">
                            <tr>
                                @canany(['property_furnishing_edit', 'property_furnishing_delete'])
                                    <th>التحكم</th>
                                @endcanany
                                <th>مستوي التشطيب</th>
                                <th>تاريخ الإضافة</th>
                                ...
                                <tr class="parents">
                                    ...
                                    @canany(['property_furnishing_edit', 'property_furnishing_delete'])
                                        <td>
                                            ...
                                            @can('property_furnishing_delete')
