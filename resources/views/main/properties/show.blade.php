                        ...
                        <div class="whatsapp-cta">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    @php
                                        $ctaMessage     = 'أرغب في الاستفسار عن هذا العقار: ' . ($row->title ?? '') . ' - ' . propertyUrl($row);
                                        $ctaWhatsappUrl = whatsappContactUrl($ctaMessage);
                                        $ctaPhone       = contactPhone();
                                    @endphp

                                    <div class="whatsapp-cta-actions">

                                        <a href="{{ $ctaWhatsappUrl ?: '#' }}" target="_blank" class="btn btn-whatsapp">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                                            class="icon icon-tabler icons-tabler-outline icon-tabler-brand-whatsapp">
                                        ...
                                        <a href="{{ $ctaPhone ? 'tel:' . $ctaPhone : '#' }}" class="btn btn-call">
