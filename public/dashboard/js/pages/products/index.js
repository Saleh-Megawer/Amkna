...
$(document).ready(function () {
    ...
    $(".btn-edit-item").click(function (e) {
        let btn = $(this),
            model = $("#update-form");
        $.post(
            adminUrl + "/products/items/get-row",
            { id: btn.attr("data-id") },
            function (row, textStatus, jqXHR) {
                ...
                $(".item-edit-image").attr(
                    "src",
                    baseUrl + "/storage/medium/products/items/" + row.image
                );
                // Update Action
                model.attr("action", adminUrl + "/products/items/item-update");
                // Update Model Name
    ...
    const uploadUrl = adminUrl + "/products/gallery-upload-store",
